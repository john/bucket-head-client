  ...
  componentDidMount() {
    ...
    fetch( config.dynamodb.URL + videoId)
      .then(function(response) {
        ...
        this.setState({video_url: config.s3.transcoded_url + videos[0]['480p_transcoded']['S']});
      ...
      <div className="videos">
          ...
          <div>
            <a href={this.state.video_url}>
    		      <img src={config.s3.transcoded_url  + this.state.video_thumbnail} alt={this.state.video_url} />
            </a>
          </div>
    		<div>
